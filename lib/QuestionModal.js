...
export default React.createClass({
  ...
  getDefaultProps() {
    return {
      ...
      lastNextQuestionClass: "nextQuestion--hidden",
  ...
  nextQuestionHandler() {
    ...
    console.log(this.state.currentQuestionIndex, this.props.questions.length);
  },
      ...
      if(radios[i].checked) {
        ...
        if((this.state.currentQuestionIndex +1) === this.props.questions.length) {
          if(radioValue == this.props.questions[this.state.currentQuestionIndex].correct){
            this.setState({
              nextQuestionButtonStatus: this.props.lastNextQuestionClass,
  ...
  render() {
    ...
    return(
      <section className={this.props.modalClass}>
        ...
        <section className="finalFeedbackModal">
